...
Blockly.Python['controls_for'] = function(block) {
    ...
    var defineUpRange = function() {
        return Blockly.Python.provideFunction_(
            'upRange', ['def ' + Blockly.Python.FUNCTION_NAME_PLACEHOLDER_ +
                '(start, stop, step):',
                '  while start <= stop:',
                '    yield start',
                '    start += abs(step)'
    ...
    var defineDownRange = function() {
        return Blockly.Python.provideFunction_(
            'downRange', ['def ' + Blockly.Python.FUNCTION_NAME_PLACEHOLDER_ +
                '(start, stop, step):',
                '  while start >= stop:',
                '    yield start',
                '    start -= abs(step)'
...
Blockly.Python['controls_while'] = function(block) {
    // While loop.
    var conditionCode = Blockly.Python.valueToCode(block, 'TEST', Blockly.Python.ORDER_NONE) || 'False';
    var branch = Blockly.Python.statementToCode(block, 'DO');
    branch = Blockly.Python.addLoopTrap(branch, block) || Blockly.Python.PASS;
...
Blockly.Python['controls_forrange'] = function(block) {
    var index = block.getFieldValue('VAR');
    ...
    var branch = Blockly.Python.statementToCode(block, 'DO');
    branch = Blockly.Python.addLoopTrap(branch, block) || Blockly.Python.PASS;
    var code = 'for ' + index + 'in range(' + start + ',' + end + ',' + step + '):\n' + branch;
    return code;
};

Blockly.Python['controls_do_then_return'] = function(block) {
  var statements_stm = Blockly.Python.statementToCode(block, 'STM');
  var value_value = Blockly.Python.valueToCode(block, 'VALUE', Blockly.Python.ORDER_ATOMIC);
  var code = statements_stm + Blockly.Python.INDENT + 'return ' + value_value + '\n';
  return code;
};