...
// New blocks' code here

Blockly.Python['math_compare'] = function (block) {
	// Copy from logic_compare
    // Comparison operator.
    var OPERATORS = {
        'EQ': '==',
        'NEQ': '!=',
...
Blockly.Python['math_add'] = function (block) {
    ...
    for (var i = 0; i < block.itemCount_; i++) {
        ...
        code += Blockly.Python.valueToCode(block, 'NUM' + i,
            Blockly.Python.ORDER_ADDITIVE) || 'None';
    }
    return [code, Blockly.Python.ORDER_ADDITIVE];
};

Blockly.Python['math_subtract'] = function (block) {
    var value_a = Blockly.Python.valueToCode(block, 'A', Blockly.Python.ORDER_ADDITIVE);
    var value_b = Blockly.Python.valueToCode(block, 'B', Blockly.Python.ORDER_ADDITIVE);
...
Blockly.Python['math_multiply'] = function (block) {
    ...
    for (var i = 0; i < block.itemCount_; i++) {
        ...
        code += Blockly.Python.valueToCode(block, 'NUM' + i,
            Blockly.Python.ORDER_MULTIPLICATIVE) || 'None';
    }
    return [code, Blockly.Python.ORDER_MULTIPLICATIVE];
};

Blockly.Python['math_division'] = function (block) {
    var value_a = Blockly.Python.valueToCode(block, 'A', Blockly.Python.ORDER_MULTIPLICATIVE);
    var value_b = Blockly.Python.valueToCode(block, 'B', Blockly.Python.ORDER_MULTIPLICATIVE);
    var code = value_a + ' / ' + value_b;
    return [code, Blockly.Python.ORDER_MULTIPLICATIVE];
};
