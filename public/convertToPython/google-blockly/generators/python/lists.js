...
Blockly.Python['lists_indexOf'] = function(block) {
    ...
    if (block.getFieldValue('END') == 'FIRST') {
        var functionName = Blockly.Python.provideFunction_(
            'first_index', ['def ' + Blockly.Python.FUNCTION_NAME_PLACEHOLDER_ +
                '(my_list, elem):',
    ...
    var functionName = Blockly.Python.provideFunction_(
        'last_index', ['def ' + Blockly.Python.FUNCTION_NAME_PLACEHOLDER_ + '(my_list, elem):',
    ...
    switch (where) {
        ...
        case 'RANDOM':
            ...
            if (mode == 'GET') {
                ...
                var functionName = Blockly.Python.provideFunction_(
                    'lists_remove_random_item', ['def ' + Blockly.Python.FUNCTION_NAME_PLACEHOLDER_ + '(myList):',
...
Blockly.Python['lists_sort'] = function(block) {
    ...
    var sortFunctionName = Blockly.Python.provideFunction_('lists_sort', ['def ' + Blockly.Python.FUNCTION_NAME_PLACEHOLDER_ +
...
Blockly.Python['lists_is_in'] = function(block) {
    // Block for checking if item in list
    ...
    var code = 'True if ' + item + ' in ' + list + ' else False';
    return [code, Blockly.Python.ORDER_NONE];
};

Blockly.Python['lists_position_in'] = function(block) {
    // Block for getting the position of item in list
    var item = Blockly.Python.valueToCode(block, 'ITEM', Blockly.Python.ORDER_ATOMIC);
    var list = Blockly.Python.valueToCode(block, 'LIST', Blockly.Python.ORDER_NONE) || '[]';
...
Blockly.Python['lists_pick_random_item'] = function(block) {
    // Block for getting a random item in list
    Blockly.Python.definitions_['import_random'] = 'import random';
    var list = Blockly.Python.valueToCode(block, 'LIST', Blockly.Python.ORDER_NONE) || '[]';
    var code = list + '[random.randint(0, len(' + list + ')-1)]';
    return [code, Blockly.Python.ORDER_MEMBER];
};

Blockly.Python['lists_select_item'] = function(block) {
    // Block for selecting item in list
    var list = Blockly.Python.valueToCode(block, 'LIST', Blockly.Python.ORDER_NONE) || '[]';
